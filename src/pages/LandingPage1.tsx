...
interface LandingPage1Props {
  ...
  setSelectedLevel: (lvl: CEFRLevel | 'all') => void;
  searchQuery: string;
  setSearchQuery: (q: string) => void;
  onStartReading: (lesson: Lesson) => void;
  onStartFlashcard: (lesson: Lesson) => void;
  onOpenSpecs: () => void;
  onNavigate: (view: string) => void;
}

export const LandingPage1: React.FC<LandingPage1Props> = ({
  featuredLesson,
  filteredLessons,
  selectedCategory,
  setSelectedCategory,
  ...
  return (
    <>
      {/* 1. Hero Section with Full-Screen Video Banner */}
      <HeroBanner
        onStartReading={() => onStartReading(featuredLesson)}
        onStartFlashcard={() => onStartFlashcard(featuredLesson)}
      ...
      <main className="flex-1 w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-3">
                  <button
                    onClick={() => onStartReading(featuredLesson)}
                  ...
                  <button
                    onClick={() => onStartFlashcard(featuredLesson)}
        ...
        {/* 3. Multi-dimensional Discovery Section */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {filteredLessons.map((lesson) => (
                <LessonCard
                  key={lesson.id}
                  lesson={lesson}
                  onOpenReader={onStartReading}
                  onOpenFlashcards={onStartFlashcard}
                />
              ))}
            </div>
          ) : (
        ...
        {/* 4. Cultural Philosophy & Pillars */}
        <CulturalPillars />

        {/* 5. Community Reflections Safe Zone Banner */}
          ...
          <div className="glass-card p-8 sm:p-12 border border-white/20">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="space-y-4 max-w-xl text-center lg:text-left">
                ...
                <h3 className="font-heading text-[#FFFDF8] text-3xl sm:text-4xl font-bold">
