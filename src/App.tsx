...
export function App() {
  ...
  const handleNavigate = (sectionId: string) => {
    if (sectionId === 'hero') {
      ...
      window.scrollTo({ top: 0, behavior: 'smooth' });
    } else if (sectionId === 'community-1' || sectionId === 'community') {
      setActiveView('community-1');
      window.scrollTo({ top: 0, behavior: 'smooth' });
    } else if (sectionId === 'community-2') {
      setActiveView('community-2');
      window.scrollTo({ top: 0, behavior: 'smooth' });
    } else if (sectionId === 'flashcard-study' || sectionId === 'demo-flashcards') {
      setActiveView('flashcard-study');
      window.scrollTo({ top: 0, behavior: 'smooth' });
    } else if (sectionId === 'bilingual-reader' || sectionId === 'demo-reader') {
      setActiveView('bilingual-reader');
      window.scrollTo({ top: 0, behavior: 'smooth' });
    }
  };
